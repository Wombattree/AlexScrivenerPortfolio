									...
									<div className="columns is-full">
										<div className="column">
											<div className="portfolioContainer" onMouseEnter={ToggleExample1} onMouseLeave={ToggleExample1}>
												...
												<a className={`portfolioText portfolioIcon ${example1Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/MerchantGame"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
										...
										<div className="portfolioContainer" onMouseEnter={ToggleExample2} onMouseLeave={ToggleExample2}>
												...
												<a className={`portfolioText portfolioIcon ${example2Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/RecipePriceChecker"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
									...
									<div className="columns is-full">
										<div className="column">
											<div className="portfolioContainer" onMouseEnter={ToggleExample3} onMouseLeave={ToggleExample3}>
												...
												<a className={`portfolioText portfolioIcon ${example3Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/TechBlog"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
										...
										<div className="portfolioContainer" onMouseEnter={ToggleExample4} onMouseLeave={ToggleExample4}>
												...
												<a className={`portfolioText portfolioIcon ${example4Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/NoteTaker"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
									...
									<div className="columns is-full">
										<div className="column">
											<div className="portfolioContainer" onMouseEnter={ToggleExample5} onMouseLeave={ToggleExample5}>
												...
												<a className={`portfolioText portfolioIcon ${example5Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/SocialNetworkAPI"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
										...
										<div className="portfolioContainer" onMouseEnter={ToggleExample6} onMouseLeave={ToggleExample6}>
												...
												<a className={`portfolioText portfolioIcon ${example6Hovered ? "fullOpacity" : "zeroOpacity"}`} href="https://github.com/Wombattree/ECommerceBackEnd"><span className="icon is-large"><i className="fa-brands fa-github fas fa-2x"></i></span></a>
